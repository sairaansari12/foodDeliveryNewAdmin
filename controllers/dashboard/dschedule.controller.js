...
app.get('/',adminAuth, async (req, res, next) => {
    ...
    try {
        ...
        return res.render('admin/schedule/viewSchedule.ejs',{data:findData});
...
app.post('/getSlots',adminAuth, async (req, res, next) => {
  var data=req.body
...
app.post('/addupdate',adminAuth,async (req, res) => {
  try {
    const data = req.body;
    var slots=[]
    var slotsRemaining=[]
